...
from util.io import hdf5datasetwriter as hdf5DW
...
# grab the list of images that we'll be decribing then randomly
...
for i in np.arange(0,len(imagePaths),bs):
    ...
    for (j,imagePath) in enumerate(batchPaths):
        # load the current image using the Keras helper utility
